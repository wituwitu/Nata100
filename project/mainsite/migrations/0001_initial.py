    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('console', models.CharField(choices=[('PC', 'PC'), ('PS4', 'PS4'), ('Xbox One', 'Xbox One'), ('Switch', 'Switch'), ('PS5', 'PS5'), ('Xbox Serie S', 'Xbox Serie S'), ('Xbox Serie X', 'Xbox Serie X')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('tagDiscord', models.CharField(max_length=36)),
                ('description', models.TextField(blank=True, max_length=250)),
                ('avatar', models.ImageField(upload_to=mainsite.models.user_directory_path)),
